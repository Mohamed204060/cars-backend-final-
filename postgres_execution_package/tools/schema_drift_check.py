...
EXPECTED_TABLES = {('sys', 'idempotency_keys'): {'columns': {'id': {'type': 'uuid', 'nullable': False, 'has_default': True},
 ...
 ('cmp', 'compatibility_records'): {'columns': {'id': {'type': 'uuid', 'nullable': False, 'has_default': True},
                                    ...
                                    'unique_constraints': ['uq_compatibility_part_trim'],
                                    'check_constraints': ['chk_compatibility_status'],
                                    'indexes': ['idx_compatibility_part', 'idx_compatibility_trim'],
                                    'partial_indexes': [],
 ...
 ('pur', 'purchase_requests'): {'columns': {'id': {'type': 'uuid', 'nullable': False, 'has_default': True},
                                ...
                                'foreign_key_constraints': {}},  # CR-022: بلا FK فعلي على condition_ref_id، بنفس نمط كل *_ref_id الأخرى في المشروع
