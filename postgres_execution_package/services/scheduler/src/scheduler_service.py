...
# ---------------------------------------------------------------------------
# أغلفة REST إدارية (Final Backend Batch Contract Extension): إنشاء/إلغاء/
# عرض مهمة يدويًا عبر واجهة إدارية؛ لا علاقة لها بـprocess_due_jobs_via_repository
# أعلاه (تلك للتنفيذ الدوري الداخلي فقط، لا REST).
# ---------------------------------------------------------------------------
